...
// uint m_type;		//type of event

// int m_msX, m_msY, m_msZ;		//mouse coordinates
// int m_key, m_keyMask;			//keyboard key and mask
// int m_x, m_y, m_width, m_height;	//updated geometry
// void* m_gc;		//graphical context
// void* m_xparam;	//additional parameter
