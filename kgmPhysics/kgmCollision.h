...
class kgmCollision: public kgmObject
{
  KGM_OBJECT(kgmCollision);
...
public:
  ...
  bool ob_collision(box3& s_box, vec3& s_start, vec3& s_end, box3& d_box,
