...
WINGDIAPI GLboolean APIENTRY glAreTexturesResident (GLsizei n, const GLu32 *textures, GLboolean *residences);
WINGDIAPI void APIENTRY glArrayElement (GLint i);
WINGDIAPI void APIENTRY glBegin (GLenum mode);
WINGDIAPI void APIENTRY glBindTexture (GLenum target, GLu32 texture);
WINGDIAPI void APIENTRY glBitmap (GLsizei width, GLsizei height, GLfloat xorig, GLfloat yorig, GLfloat xmove, GLfloat ymove, const GLubyte *bitmap);
WINGDIAPI void APIENTRY glBlendFunc (GLenum sfactor, GLenum dfactor);
WINGDIAPI void APIENTRY glCallList (GLu32 list);
...
WINGDIAPI void APIENTRY glColor3ui (GLu32 red, GLu32 green, GLu32 blue);
WINGDIAPI void APIENTRY glColor3uiv (const GLu32 *v);
WINGDIAPI void APIENTRY glColor3us (GLu16 red, GLu16 green, GLu16 blue);
WINGDIAPI void APIENTRY glColor3usv (const GLu16 *v);
...
WINGDIAPI void APIENTRY glColor4ui (GLu32 red, GLu32 green, GLu32 blue, GLu32 alpha);
WINGDIAPI void APIENTRY glColor4uiv (const GLu32 *v);
WINGDIAPI void APIENTRY glColor4us (GLu16 red, GLu16 green, GLu16 blue, GLu16 alpha);
WINGDIAPI void APIENTRY glColor4usv (const GLu16 *v);
...
WINGDIAPI void APIENTRY glDeleteLists (GLu32 list, GLsizei range);
WINGDIAPI void APIENTRY glDeleteTextures (GLsizei n, const GLu32 *textures);
...
WINGDIAPI GLu32 APIENTRY glGenLists (GLsizei range);
WINGDIAPI void APIENTRY glGenTextures (GLsizei n, GLu32 *textures);
...
WINGDIAPI void APIENTRY glGetPixelMapuiv (GLenum map, GLu32 *values);
WINGDIAPI void APIENTRY glGetPixelMapusv (GLenum map, GLu16 *values);
...
WINGDIAPI void APIENTRY glIndexMask (GLu32 mask);
...
WINGDIAPI GLboolean APIENTRY glIsList (GLu32 list);
WINGDIAPI GLboolean APIENTRY glIsTexture (GLu32 texture);
...
WINGDIAPI void APIENTRY glLineStipple (GLint factor, GLu16 pattern);
WINGDIAPI void APIENTRY glLineWidth (GLfloat width);
WINGDIAPI void APIENTRY glListBase (GLu32 base);
WINGDIAPI void APIENTRY glLoadIdentity (void);
WINGDIAPI void APIENTRY glLoadMatrixd (const GLdouble *m);
WINGDIAPI void APIENTRY glLoadMatrixf (const GLfloat *m);
WINGDIAPI void APIENTRY glLoadName (GLu32 name);
...
WINGDIAPI void APIENTRY glNewList (GLu32 list, GLenum mode);
...
WINGDIAPI void APIENTRY glPixelMapuiv (GLenum map, GLsizei mapsize, const GLu32 *values);
WINGDIAPI void APIENTRY glPixelMapusv (GLenum map, GLsizei mapsize, const GLu16 *values);
...
WINGDIAPI void APIENTRY glPrioritizeTextures (GLsizei n, const GLu32 *textures, const GLclampf *priorities);
WINGDIAPI void APIENTRY glPushAttrib (GLbitfield mask);
WINGDIAPI void APIENTRY glPushClientAttrib (GLbitfield mask);
WINGDIAPI void APIENTRY glPushMatrix (void);
WINGDIAPI void APIENTRY glPushName (GLu32 name);
...
WINGDIAPI void APIENTRY glSelectBuffer (GLsizei size, GLu32 *buffer);
WINGDIAPI void APIENTRY glShadeModel (GLenum mode);
WINGDIAPI void APIENTRY glStencilFunc (GLenum func, GLint ref, GLu32 mask);
WINGDIAPI void APIENTRY glStencilMask (GLu32 mask);
